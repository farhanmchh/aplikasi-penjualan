              ...
              <div class="timeline timeline-6 mt-3">
                ...
                <div class="timeline-item align-items-start">
                  ...
                  <div class="timeline-content font-weight-mormal font-size-lg text-muted pl-3">Outlines keep and you
                    honest. Indulging in poorly driving</div>
                  <!--end::Text-->
                </div>
                <!--end::Item-->
                <!--begin::Item-->
        ...
        <div class="col-lg-6 col-xxl-4">
          ...
          <div class="card card-custom card-stretch card-stretch-half gutter-b">
            ...
            <div class="card-body p-0">
              ...
              <div id="kt_stats_widget_11_chart" class="card-rounded-bottom" data-color="success" style="height: 150px">
              </div>
            </div>
            <!--end::Body-->
          </div>
          ...
          <div class="card card-custom card-stretch card-stretch-half gutter-b">
            ...
            <div class="card-body p-0">
              ...
              <div id="kt_stats_widget_12_chart" class="card-rounded-bottom" data-color="primary" style="height: 150px">
              </div>
            </div>
            <!--end::Body-->
          </div>
